...
export async function generateMetadata({
  ...
  return pageMeta({
    ...
    title: t("About"),
    description:
      t("A private engineering company in southern Vietnam specialising in modular datacenter infrastructure, Bitcoin mining, AI and renewable energy."),
    path: "/company",
  });
}

export default async function CompanyPage({ params }: LangPageProps) {
  const { lang: rawLang } = await params;
  const lang = toLocale(rawLang);
  const t = translator(lang);
    ...
    <>
      ...
      >
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-12">
          <p className="reveal text-xl leading-relaxed text-ink">
      ...
      <Section tone="linen">
        <div className="mx-auto max-w-[44ch] text-center">
          ...
          <p className="reveal mt-10 leading-relaxed text-slate">
      ...
      <Section index="02" label="History" title={"How we\ngot here."}>
        ...
        <p className="reveal mt-8 max-w-[64ch] text-sm text-slate-dim">
      ...
      >
        ...
        <div className="reveal mt-10 flex flex-wrap items-center gap-4">
          <Button lang={lang} href="/company/leadership">Leadership</Button>
