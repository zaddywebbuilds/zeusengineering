...
export async function generateMetadata({
  ...
  return pageMeta({
    ...
    title: t("Leadership"),
    description:
      t("The ZEUS Engineering leadership team: Tatts Nguyen, Chris Gainer, Quynh Nguyen and Valentine Cheval."),
...
export default async function LeadershipPage({ params }: LangPageProps) {
  const { lang: rawLang } = await params;
  const lang = toLocale(rawLang);
  const t = translator(lang);
    ...
    <>
      ...
      <Section>
        ...
        <div className="reveal mt-10 flex flex-wrap items-center gap-4">
          <Button lang={lang} href="/company">About ZEUS</Button>
