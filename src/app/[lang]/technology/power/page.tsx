...
export async function generateMetadata({
  ...
  return pageMeta({
    lang,
    title: t("Power Architecture"),
    description:
      t("ZEUS Engineering power architecture - grid integration, solar generation, distribution and grid load balancing for high-density compute."),
