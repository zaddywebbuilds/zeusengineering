...
export async function generateMetadata({
  ...
  return pageMeta({
    lang,
    title: t("Investor Brief"),
    description:
      t("A one-page investor brief for ZEUS Engineering, generated from the same figures the rest of this site renders. Print or save as PDF."),
...
export default async function BriefPage({ params }: LangPageProps) {
  const { lang: rawLang } = await params;
  const lang = toLocale(rawLang);
  const t = translator(lang);
        ...
        <div>
          <nav aria-label="Breadcrumb" className="mb-4">
            <ol className="flex flex-wrap items-center gap-2">
              <li>
                <LocaleLink lang={lang} href="/" className="tech-label hover:text-ink">
                  Home
                </LocaleLink>
              </li>
              ...
              <li>
                <LocaleLink lang={lang} href="/investors" className="tech-label hover:text-ink">
                  Investors
                </LocaleLink>
              </li>
            </ol>
        ...
        <Block title={t("The ask")}>
          <div className="flex flex-wrap items-end gap-x-8 gap-y-4">
            ...
            <div className="pb-2">
              ...
              <p className="tech-label mt-3">{t("18–24 month runway to live nodes")}</p>
            </div>
          </div>
