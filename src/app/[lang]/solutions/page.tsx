...
export async function generateMetadata({
  ...
  return pageMeta({
    ...
    title: t("Solutions"),
    description:
      t("Modular data centers, AI infrastructure, Bitcoin infrastructure, hosted mining and energy integration, the five areas ZEUS Engineering builds in."),
    path: "/solutions",
  });
}

export default async function SolutionsPage({ params }: LangPageProps) {
  const { lang: rawLang } = await params;
  const lang = toLocale(rawLang);
  const t = translator(lang);
