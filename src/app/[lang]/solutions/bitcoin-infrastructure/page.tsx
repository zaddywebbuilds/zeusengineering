...
export async function generateMetadata({
  ...
  return pageMeta({
    lang,
    title: t("Bitcoin Infrastructure"),
    description:
      t("ZEUS Engineering's Bitcoin mining infrastructure in Vietnam: ASIC deployment, power, cooling, monitoring and maintenance, run continuously."),
...
export default async function BitcoinInfrastructurePage({ params }: LangPageProps) {
  const { lang: rawLang } = await params;
  const lang = toLocale(rawLang);
  const t = translator(lang);
