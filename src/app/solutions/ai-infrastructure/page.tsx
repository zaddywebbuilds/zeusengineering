  ...
  return (
    <>
            ...
            <ul className="space-y-3 text-sm text-steel">
              {[
                ...
                <li key={item} className="flex gap-3">
                  <span aria-hidden className="mt-2 h-px w-4 shrink-0 bg-steel-dim" />
                  {item}
                </li>
              ))}
            </ul>
      ...
      <Section>
        ...
        <div className="mt-16 grid grid-cols-1 gap-px bg-[var(--rule)] sm:grid-cols-2 lg:grid-cols-3">
          {ai1.specs?.map((group) => (
            <div key={group.group} className="reveal bg-graphite p-7">
              <h3 className="tech-label text-engineering">{group.group}</h3>
              <ul className="mt-5 space-y-2.5">
                {group.items.map((item) => (
                  <li key={item} className="flex gap-3 text-sm text-steel">
                    <span aria-hidden className="mt-2 h-px w-4 shrink-0 bg-cyan/60" />
                    {item}
                  </li>
                ))}
              </ul>
        ...
        <div className="mt-px grid grid-cols-1 gap-px bg-[var(--rule)] sm:grid-cols-2 lg:grid-cols-3">
          {ai1.features?.map((feature) => (
            <div key={feature.title} className="reveal bg-carbon p-7">
